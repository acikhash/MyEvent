            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Event</p>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">This Month Events</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $thisMonthEvents->count() }}
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Today's Guest</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $todayGuests->count() }}
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">This Month Guests</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $thisMonthGuests->count() }}
        ...
        <div class="col-lg-7">
            <div class="card z-index-2">
                <div class="card-header pb-0">
                    <h6>Guest Trend overview</h6>
                    <p class="text-sm">
                        For Event with Guest only
                        <input type="hidden" name="countEvent" id="countEvent" value={{ $trends->count() }}>
                        <?php $i = 0; ?>
                        @foreach ($trends as $trend)
                            <?php $i++; ?>
                            <input type="hidden" name="{{ 'totalGuest' . $i }}" id="{{ 'totalGuest' . $i }}"
                                value="{{ $trend->totalGuest }}">
                            <input type="hidden" name="{{ 'checkedin' . $i }}" id="{{ 'checkedin' . $i }}"
                                value="{{ $trend->checkedin }}">
                            <input type="hidden" name="{{ 'attendance' . $i }}" id="{{ 'attendance' . $i }}"
            ...
            @push('dashboard')
                <script>
                    window.onload = function() {
                        ...
                        gradientStroke3.addColorStop(1, 'rgba(173, 255, 47,0.2)');
