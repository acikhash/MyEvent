        ...
        <div class="card-body pt-4 p-3">
            <form method="POST" action="{{ route('guest.RepresentativeStore') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="checkbox" id="bringingRepresentative" name="bringingRepresentative">
                            <label for="bringingRepresentative">{{ __('Bringing Representative') }}</label>
                        </div>
                    </div>
                </div>
                ...
                <div id="representativeForm" style="display: none;">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="repName" class="form-control-label">{{ __('Representative Name') }}</label>
                                <input class="form-control" type="text" placeholder="i.e: John Doe" id="repName" name="repName">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="repContact" class="form-control-label">{{ __('Representative Contact') }}</label>
                                <input class="form-control" type="tel" placeholder="0123456789" id="repContact" name="repContact">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    document.getElementById('bringingRepresentative').addEventListener('change', function() {
        var representativeForm = document.getElementById('representativeForm');
        if (this.checked) {
